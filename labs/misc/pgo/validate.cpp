...
int main(int argc, char** argv)
{
    ...
    char const* run_validation_tests[] = {"lua", "../run_bench_tests.lua", "test", outputFileName.c_str(), 0};
    ...
    char const* check_md5[] = {"lua", "../md5/check_md5.lua", outputFileName.c_str(), 0};
    ...
    std::string const outputMd5FileName = "output.txt.md5";
    std::string const refOutputMd5FName = argv[1];
    ...
    {
        std::cerr << "Validation Failed. Hashes do not match. Output hash = " << outContents << "; Reference hash = " << refContents << "\n";
        return 1;
    }
