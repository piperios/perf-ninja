...
constexpr inline size_t sequence_size_v = 200;  // The length of the generated sequences.
constexpr inline size_t sequence_count_v = 16;  // The number of sequences to generate for both sequence collections.
